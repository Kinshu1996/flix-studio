...
const  CatalogTeamItem = ({ className, item, i, halfwayIndex, itemHeight, shuffleThreshold, activeIndex, setActiveIndex, data}) => {
  ...
  return (
    <div  onClick={() => setActiveIndex(i)} className={className} style={inlineStyles}>
    {console.log(item.id)}
